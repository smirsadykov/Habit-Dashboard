...
assert.match(buildIcs("08:00", morning, URLS), /SUMMARY:Day Desk — morning/, "morning wording before noon");
assert.match(ics, /SUMMARY:Day Desk — evening check-in/, "evening wording after");
